...
class Memory_Decode(GridAgentTask):
    """
    ## Description
    This task follows the same rules as "Decode". The agent must
    additionally remember the relationships indicated in the code
    table, which will disappear once the game starts.
    """
